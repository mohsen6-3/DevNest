...
urlpatterns = [
    ...
    path('<int:nest_id>/posts/<int:post_id>/pin/',                      post_views.pin_post_view,         name='nest_pin_post'),
    path('<int:nest_id>/posts/<int:post_id>/comment/<int:comment_id>/delete/', post_views.delete_comment_view, name='nest_delete_comment'),
    path('<int:nest_id>/join/',   views.join_nest_view,         name='join_nest'),
    path('<int:nest_id>/manage/', views.manage_nest_view,       name='manage_nest'),
    path('create/',               views.create_nest_view,       name='create_nest'),
]